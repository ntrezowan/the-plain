...
1. Save existing Search Service Application into a variable;
```
$ssa = Get-SPEnterpriseSearchServiceApplication
```

2. Add a second index component to existing topology and wait until it is replicated to the other server;
```
$ssa = Get-SPEnterpriseSearchServiceApplication -SearchApplication $ssa -Active
```
